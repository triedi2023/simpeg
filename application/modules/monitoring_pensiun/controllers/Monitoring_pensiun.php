...
class Monitoring_pensiun extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('monitoring_pensiun/monitoring_pensiun_model', 'list_model'));
        $this->load->helper(array('form', 'app_helper'));
        $this->data['plugin_js'] = ['assets/plugins/select2/js/select2.full.min.js'];
        $this->data['custom_js'] = ['monitoring_pensiun/js', 'system/unitkerja_form-horizontal_filter_js'];
        $this->data['title_utama'] = 'Monitoring Pensiun';
    }

    public function index() {
        $this->data['content'] = 'monitoring_pensiun/index';
    ...
    public function pencarian_proses() {
        ...
        $this->data['model'] = $this->monitoring_pensiun_model->get_data($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5,$gol_pangkat,$eselon_id,$bulan,$tahun,$bulan1,$tahun1);
        $this->data['struktur'] = $this->monitoring_pensiun_model->get_struktur($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5);
        
        $this->load->view("monitoring_pensiun/_hasil", $this->data);
    }
    ...
    public function export_excel() {
        ...
        $model = $this->monitoring_pensiun_model->get_data($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5,$gol_pangkat,$eselon_id,$bulan,$tahun,$bulan1,$tahun1);
        $struktur = $this->monitoring_pensiun_model->get_struktur($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5);
        $jumlah = count($model);
    ...
    public function export_pdf() {
        ...
        $this->data['model'] = $this->monitoring_pensiun_model->get_data($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5,$gol_pangkat,$eselon_id,$bulan,$tahun,$bulan1,$tahun1);
        $this->data['struktur'] = $this->monitoring_pensiun_model->get_struktur($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5);
        $this->data['content'] = 'monitoring_pensiun/pdf';
