                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-title">
                            ...
                            <ul class="page-breadcrumb breadcrumb">
                                ...
                                <li>
                                    <a href="javascript:;">Daftar Nominatif</a>
                                    <i class="fa fa-angle-right"></i>
                                </li>
                                <li>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-content-inner">
                            <div class="m-heading-1 border-green m-bordered">
                                <h3>Parameter</h3>
                                <div class="form">
                                    <form action="#" class="form-horizontal" id="formpencarian" data-url="<?php echo site_url("daftar_nominatif_gabungan/pencarian_proses") ?>">
                                        <div class="form-body">
