        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                <div class="btn-group btn-group-devided" data-toggle="buttons">
                    ...
                    <a class="btn btn-transparent red btn-outline btn-circle btn-sm btnexport" data-url="<?php echo site_url("daftar_nominatif_gabungan/export_excel") ?>">
                ...
                <table class="table table-bordered table-hover table-striped table-advance">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 10%"> TMT Pangkat </th>
                            <th class="text-center"> Jabatan </th>
                            <th class="text-center" style="width: 10%"> TMT Jabatan </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
