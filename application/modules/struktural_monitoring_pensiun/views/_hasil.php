...
<div class="col-md-12">
    ...
    <div class="portlet light ">
        <div class="portlet-title">
            ...
            <div class="actions">
                <div class="btn-group btn-group-devided" data-toggle="buttons">
                    ...
                    <a class="btn btn-transparent red btn-outline btn-circle btn-sm btnexport" data-url="<?php echo site_url("struktural_monitoring_pensiun/export_excel") ?>">
                        <i class="fa fa-file-excel-o"></i> Excel
                    </a>
                    <a class="btn btn-transparent red btn-outline btn-circle btn-sm btnexport" data-url="<?php echo site_url("struktural_monitoring_pensiun/export_pdf") ?>">
        ...
        <div class="portlet-body">
            <h1 class="text-center">Monitoring Pensiun</h1>
            <?php echo $nmstruktur; ?>
                ...
                <table class="table table-bordered table-hover table-striped table-advance">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 10%"> Kelompok Jabatan </th>
                            <th class="text-center"> Jabatan<br />TMT Jabatan </th>
                        ...
                        <?php if ($model): ?>
                            ...
                            foreach ($model as $val):
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo $val['KEL_JABATAN'] ?> </td>
