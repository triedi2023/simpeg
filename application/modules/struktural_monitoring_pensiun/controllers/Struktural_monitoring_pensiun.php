...
class Struktural_monitoring_pensiun extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('struktural_monitoring_pensiun/struktural_monitoring_pensiun_model', 'list_model'));
        $this->load->helper(array('form', 'app_helper'));
        $this->data['plugin_js'] = ['assets/plugins/select2/js/select2.full.min.js'];
        $this->data['custom_js'] = ['struktural_monitoring_pensiun/js', 'system/unitkerja_form-horizontal_filter_js'];
        $this->data['title_utama'] = 'Monitoring Pensiun';
    }

    public function index() {
        $this->data['content'] = 'struktural_monitoring_pensiun/index';
    ...
    public function pencarian_proses() {
        ...
        $this->data['model'] = $this->struktural_monitoring_pensiun_model->get_data($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5,$gol_pangkat,$eselon_id,$bulan,$tahun,$bulan1,$tahun1);
        $this->data['struktur'] = $this->struktural_monitoring_pensiun_model->get_struktur($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5);
        
        $this->load->view("struktural_monitoring_pensiun/_hasil", $this->data);
    }
    ...
    public function export_excel() {
        ...
        $model = $this->struktural_monitoring_pensiun_model->get_data($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5,$gol_pangkat,$eselon_id,$bulan,$tahun,$bulan1,$tahun1);
        $struktur = $this->struktural_monitoring_pensiun_model->get_struktur($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5);
        $jumlah = count($model);
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('A1', 'Monitoring Pensiun');
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('D' . $judultabel, "Jabatan")
                ->setCellValue('E' . $judultabel, "Jabatan / a. TMT Jabatan")
        ...
        if ($model) {
            foreach ($model as $val) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('D' . $j, $val['KEL_JABATAN'])
                        ->setCellValue('E' . $j, $val['N_JABATAN']."\n"."a. ".$val['TMT_JABATAN'])
        ...
        $objPHPExcel->getActiveSheet()->getHeaderFooter()->setOddHeader('&L&G&C&HDAFTAR MONITORING PENSIUN ' . $this->config->item('instansi_panjang'));
    ...
    public function export_pdf() {
        ...
        $this->data['model'] = $this->struktural_monitoring_pensiun_model->get_data($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5,$gol_pangkat,$eselon_id,$bulan,$tahun,$bulan1,$tahun1);
        $this->data['struktur'] = $this->struktural_monitoring_pensiun_model->get_struktur($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5);
        $this->data['content'] = 'struktural_monitoring_pensiun/pdf';
