...
class Struktural_monitoring_pensiun_model extends CI_Model {
    ...
    function get_data($lok='2',$kdu1='00',$kdu2='00',$kdu3='000',$kdu4='000',$kdu5='00',$gol_pangkat="",$eselon_id="",$bulan="",$tahun='',$bulan1="",$tahun1='') {
        ...
        $sql = "SELECT * FROM V_MONITORING_PENSIUN WHERE TRESELON_ID NOT IN ('13','15','17') $where ORDER BY TMT_PENSIUN ASC";
