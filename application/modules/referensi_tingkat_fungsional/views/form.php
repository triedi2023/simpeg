<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('referensi_tingkat_fungsional/ubah_proses?id='.$id) : site_url('referensi_tingkat_fungsional/tambah_proses')]); ?>
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="tkt_fungsional" id="field_cr_tkt_fungsional" class="form-control" value="<?php echo isset($id) ? $model->TINGKAT_FUNGSIONAL : set_value('tkt_fungsional'); ?>" maxlength="50" minlength="2" placeholder="<?=$title_utama;?>" />
                        </div>
                    </div>
                    <!--/span-->
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label">Jenjang Fungsional <span class="required" aria-required="true"> * </span></label>
                            <select name="jenjang_fungsional" id="field_cr_jenjang_fungsional" class="form-control">
