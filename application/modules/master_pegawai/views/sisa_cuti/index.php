    ...
    <div class="col-md-12">
        <div class="portlet box blue-dark">
            ...
            <div class="portlet-body">
                <div class="listdetailpegawai table-container" data-url="<?php echo site_url('master_pegawai/master_pegawai_sisa_cuti/ajax_list?id='.$id) ?>">
...
<script>
    ...
    var $datatablesdetailpegawai = $('table.defaultgridviewdetailpegawai').DataTable({
        ...
        processing: true,
        ajax: {
            url: '<?php echo site_url('master_pegawai/master_pegawai_sisa_cuti/ajax_list?id='.$id) ?>',
            type: 'POST',
            data: datasearch
        }
    });
    <?php if ($this->session->userdata('idgroup') != '' && $this->session->userdata('idgroup') != '3') { ?>
    $("div.toolbar").html('<a href="javascript:;" data-url="<?php echo site_url('master_pegawai/master_pegawai_sisa_cuti/tambah_form?id='.$id); ?>" class="btndefaultshowtambahubahdetailpegawai btn blue btn-sm btn-circle"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Tambah Data</a>');
    <?php } ?>
</script>