                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="portlet box yellow-gold">
                                        ...
                                        <div class="portlet-body form">
                                            ...
                                            <!-- BEGIN FORM-->
                                            <?php echo form_open(site_url('master_pegawai/import_cpns'), ["class" => "horizontal-form", "enctype" => 'multipart/form-data']); ?>
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <a target="_blank" href="<?php echo site_url('master_pegawai/format_excel_cpns') ?>" class="btn btn-transparent red btn-outline btn-circle btn-sm" title="Unduh Format Excel"><i class="fa fa-file-excel-o"></i></a>
                                                        </div>
                                                    </div>
                                                    <!--/span-->
                                                    <div class="col-md-8">
