<div class="col-md-12">
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-gift"></i><?php echo $title_form; ?> Data Diklat Kepemimpinan 
            </div>
            <div class="tools">&nbsp;</div>
        </div>
        <div class="portlet-body form">
            <?php echo form_open("://", ["class" => "formdetailpegawaiwithlist form-horizontal", 'data-url' => !isset($model['ID']) ? site_url('master_pegawai/master_pegawai_diklat_penjenjangan/tambah_proses?id=' . $id) : site_url('master_pegawai/master_pegawai_diklat_penjenjangan/ubah_proses?id=' . $model['TMPEGAWAI_ID'] . "&kode=" . $model['ID'])]); ?>
            <div class="form-body">
                        ...
                        <select name="penjenjangan" id="field_cr_penjenjangan" class="form-control" style="width: 100%">
                            <?php if (isset($list_tingkat_diklat_kepemimpinan)): ?>
                                <?php foreach ($list_tingkat_diklat_kepemimpinan as $val): ?>
                                    <?php
                                    $selec = '';
                                    if ($val['ID'] == $model['TRTINGKATDIKLATKEPEMIMPINAN_ID'])
                                        $selec = 'selected=""';
                                    ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="angkatan" maxlength="8" id="field_cr_angkatan" class="form-control" value="<?php echo isset($model['ANGKATAN_DIKLAT']) ? $model['ANGKATAN_DIKLAT'] : set_value('angkatan'); ?>" placeholder="Angkatan" />
                    </div>
                    <div class="col-md-3">
                        <input type="text" name="tahun" maxlength="4" id="field_cr_tahun" class="form-control" value="<?php echo isset($model['THN_DIKLAT']) ? $model['THN_DIKLAT'] : set_value('tahun'); ?>" placeholder="Tahun" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <input type="text" name="jpl" maxlength="4" id="field_cr_jpl" class="form-control" value="<?php echo isset($model['JPL']) ? $model['JPL'] : set_value('jpl'); ?>" placeholder="JPL" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" name="peringkat" maxlength="8" id="field_cr_peringkat" class="form-control" value="<?php echo isset($model['PERINGKAT']) ? $model['PERINGKAT'] : set_value('peringkat'); ?>" placeholder="peringkat" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <?php if (!empty($model['DOC_PENJENJANGAN']) && $model['DOC_PENJENJANGAN'] <> '') { ?>
                        <div class="col-md-1">
                            <a href="javascript:;" data-url="<?php echo site_url('master_pegawai/master_pegawai_diklat_penjenjangan/view_dokumen?id='.$model['ID']) ?>" title="Lihat Dokumen" class="btn btn-circle btn-icon-only green-haze popupfull">
