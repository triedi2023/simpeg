<div class="col-md-12">
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-gift"></i><?php echo $title_form; ?> Data Orang Tua 
            </div>
            <div class="tools">&nbsp;</div>
        </div>
        <div class="portlet-body form">
            <?php echo form_open("://", ["class" => "formdetailpegawaiwithlist form-horizontal", 'data-url' => !isset($model['ID']) ? site_url('master_pegawai/master_pegawai_ortu/tambah_proses?id='.$id) : site_url('master_pegawai/master_pegawai_ortu/ubah_proses?id='.$id."&kode=".$model['ID'])]); ?>
            <div class="form-body">
...
<script>
    $("select#field_cr_status_ortu").select2();
