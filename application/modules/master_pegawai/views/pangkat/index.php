    ...
    <div class="col-md-12">
        <div class="portlet box blue-dark">
            ...
            <div class="portlet-body">
                <div class="listdetailpegawai table-container" data-url="<?php echo site_url('master_pegawai/master_pegawai_pangkat/ajax_list?id='.$id) ?>">
                    <table class="defaultgridviewdetailpegawai table table-striped table-bordered table-hover order-column dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Jenis Pangkat</th>
                                <th class="text-center">Masa Kerja Gol</th>
...
<script>
    ...
    var $datatablesdetailpegawai = $('table.defaultgridviewdetailpegawai').DataTable({
        ...
        processing: true,
        ajax: {
            url: '<?php echo site_url('master_pegawai/master_pegawai_pangkat/ajax_list?id='.$id) ?>',
            type: 'POST',
            data: datasearch
        }
    });
    ...
    $("div.toolbar").html('<a href="javascript:;" data-url="<?php echo site_url('master_pegawai/master_pegawai_pangkat/tambah_form?id='.$id); ?>" class="btndefaultshowtambahubahdetailpegawai btn blue btn-sm btn-circle"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Tambah Data</a>');
    <?php } ?>
</script>