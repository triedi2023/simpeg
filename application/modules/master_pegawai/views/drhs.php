    ...
    <div class="portlet-title">
        ...
        <div class="actions">
            <div class="btn-group btn-group-devided" data-toggle="buttons">
                ...
                <a class="btn btn-transparent red btn-outline btn-circle btn-sm btnexportdrhsp" data-url="<?php echo site_url("master_pegawai/export_excel_drhs?id=".$pegawai['ID']) ?>">
                    <i class="fa fa-file-excel-o"></i> Excel
                </a>
                <a class="btn btn-transparent red btn-outline btn-circle btn-sm btnexportdrhsp" data-url="<?php echo site_url("master_pegawai/export_pdf_drhs?id=".$pegawai['ID']) ?>">
