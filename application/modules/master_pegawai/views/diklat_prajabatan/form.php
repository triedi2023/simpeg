<div class="col-md-12">
    <div class="portlet box blue">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-gift"></i><?php echo $title_form; ?> Data Diklat Prajabatan 
            </div>
            <div class="tools">&nbsp;</div>
        </div>
        <div class="portlet-body form">
            <?php echo form_open("://", ["class" => "formdetailpegawaiwithlist form-horizontal", 'data-url' => !isset($model['ID']) ? site_url('master_pegawai/master_pegawai_diklat_prajabatan/tambah_proses?id=' . $id) : site_url('master_pegawai/master_pegawai_diklat_prajabatan/ubah_proses?id=' . $model['TMPEGAWAI_ID'] . "&kode=" . $model['ID'])]); ?>
            <div class="form-body">

                <div class="form-group">
                    <label class="control-label col-md-4">Nama Diklat <span class="required" aria-required="true"> * </span></label>
                    <div class="col-md-7">
                        <input type="text" name="nama_diklat" maxlength="255" id="field_cr_nama_diklat" class="form-control" value="<?php echo isset($model['NAMA_DIKLAT']) ? $model['NAMA_DIKLAT'] : set_value('nama_diklat'); ?>" placeholder="Nama Diklat" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-4">Lama Diklat (JPL)</label>
                    <div class="col-md-7">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-7">
                        <input type="text" name="penyelenggara" maxlength="300" id="field_cr_penyelenggara" class="form-control" value="<?php echo isset($model['PENYELENGGARA']) ? $model['PENYELENGGARA'] : set_value('penyelenggara'); ?>" placeholder="Penyelenggara" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-md-4">Dokumen</label>
                    <div class="col-md-7">
                    ...
                    <?php if (!empty($model['DOC_PRAJABATAN']) && $model['DOC_PRAJABATAN'] <> '') { ?>
                        <div class="col-md-1">
                            <a href="javascript:;" data-url="<?php echo site_url('master_pegawai/master_pegawai_diklat_prajabatan/view_dokumen?id='.$model['ID']) ?>" title="Lihat Dokumen" class="btn btn-circle btn-icon-only green-haze popupfull">
