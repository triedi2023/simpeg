    ...
    public function tambah_proses() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($this->master_pegawai_model->insert($post, $tanggal)) {
                $arrayerrorupload = [];
                $dokumen = [];
                if (!is_dir($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))))) {
                    mkdir($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))), 0777);
                }

                if (!empty($_FILES['doc_karpeg']['name'])) {
                    $config['upload_path'] = $this->config->item('uploadpath') . 'doc_pegawai/' . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE)));
                    ...
                    if ($this->upload->do_upload('doc_karpeg')) {
                        if (file_exists($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/" . $config['file_name']))
    ...
    public function ubah_datapokok_biodata() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (trim($data_pegawai['NIP']) != trim($this->input->post('nipold', TRUE))) {
                rename($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($data_pegawai['NIP'])), $this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))));
            }

            $dokumen = [];
            if (!empty($_FILES['doc_karpeg']['name'])) {
                if (file_exists($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/doc_karpeg.pdf")) {
                    unlink($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/doc_karpeg.pdf");
                }
                $config['upload_path'] = $this->config->item('uploadpath') . 'doc_pegawai/' . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE)));
                $config['allowed_types'] = 'pdf';
                $config['max_size'] = '2048';
            ...
            if (!empty($_FILES['doc_karisu']['name'])) {
                if (file_exists($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/doc_karis.pdf")) {
                    unlink($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/doc_karis.pdf");
                }
                $config['upload_path'] = $this->config->item('uploadpath') . 'doc_pegawai/' . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE)));
                $config['allowed_types'] = 'pdf';
                $config['max_size'] = '2048';
            ...
            if (!empty($_FILES['doc_tapen']['name'])) {
                if (file_exists($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/doc_tapen.pdf")) {
                    unlink($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/doc_tapen.pdf");
                }
                $config['upload_path'] = $this->config->item('uploadpath') . 'doc_pegawai/' . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE)));
                $config['allowed_types'] = 'pdf';
                $config['max_size'] = '2048';
            ...
            if (!empty($_FILES['doc_ktp']['name'])) {
                if (file_exists($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/doc_ktp.pdf")) {
                    unlink($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/doc_ktp.pdf");
                }
                $config['upload_path'] = $this->config->item('uploadpath') . 'doc_pegawai/' . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE)));
                $config['allowed_types'] = 'pdf';
                $config['max_size'] = '2048';
            ...
            if (!empty($_FILES['doc_askes']['name'])) {
                if (file_exists($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/doc_akses.pdf")) {
                    unlink($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/doc_askes.pdf");
                }
                $config['upload_path'] = $this->config->item('uploadpath') . 'doc_pegawai/' . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE)));
                $config['allowed_types'] = 'pdf';
                $config['max_size'] = '2048';
            ...
            if (!empty($_FILES['doc_npwp']['name'])) {
                if (file_exists($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/doc_npwp.pdf")) {
                    unlink($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE))) . "/doc_npwp.pdf");
                }
                $config['upload_path'] = $this->config->item('uploadpath') . 'doc_pegawai/' . preg_replace('/[^A-Za-z0-9\-]/', '-', trim($this->input->post('nipold', TRUE)));
                $config['allowed_types'] = 'pdf';
                $config['max_size'] = '2048';
...
//                $this->Log_model->insert_log("Ubah","Biodata Pegawai Dengan NIP ".(isset($data_pegawai['NIPNEW']) ? $data_pegawai['NIPNEW'] : $data_pegawai['NIP']));
    ...
    public function view_dokumen() {
        ...
        if (isset($model['NIP']) && $model['NIP'] != "") {
            if (file_exists($this->config->item('uploadpath') . "doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', $model['NIP']) . "/" . $this->input->get('dokumen') . ".pdf")) {
                $this->data['file'] = base_url() . "_uploads/doc_pegawai/" . preg_replace('/[^A-Za-z0-9\-]/', '-', $model['NIP']) . "/" . $this->input->get('dokumen') . ".pdf";
            }
        }
    ...
    public function import_cpns() {
        $this->load->model(array('master_pegawai/master_pegawai_cpns_model', 'master_pegawai/master_pegawai_jabatan_model'));
        ...
        if ($this->input->method() === "post") {
            ...
            for ($row = 3; $row <= $highestRow; ++$row) {
                if (trim($objWorksheet->getCellByColumnAndRow(0, $row)) != "" && trim($objWorksheet->getCellByColumnAndRow(1, $row)) != "") {
                    ...
                    $lokasi = ltrim(rtrim($objWorksheet->getCellByColumnAndRow(15, $row)));
                    $kdu1 = str_replace("'", "",ltrim(rtrim($objWorksheet->getCellByColumnAndRow(16, $row))));
                    $kdu2 = str_replace("'", "",ltrim(rtrim($objWorksheet->getCellByColumnAndRow(17, $row))));
                    $kdu3 = str_replace("'", "",ltrim(rtrim($objWorksheet->getCellByColumnAndRow(18, $row))));
                    $kdu4 = str_replace("'", "",ltrim(rtrim($objWorksheet->getCellByColumnAndRow(19, $row))));
                    $kdu5 = str_replace("'", "",ltrim(rtrim($objWorksheet->getCellByColumnAndRow(20, $row))));
                    $kodejabatan = str_replace("'", "",ltrim(rtrim($objWorksheet->getCellByColumnAndRow(14, $row))));

                    if ($this->master_pegawai_model->insert($post, $tanggal)) {
                        $data_pegawai = $this->master_pegawai_model->get_by_nipnew_select(trim($objWorksheet->getCellByColumnAndRow(1, $row)), "ID,NIP,NIPNEW");
                        $cpns = [
                            "TRESELON_ID" => str_replace("'", "",ltrim(rtrim($objWorksheet->getCellByColumnAndRow(13, $row)))),
                        ...
                        $mecah = explode('-', trim(str_replace(" ", "",$objWorksheet->getCellByColumnAndRow(21, $row))));
                        $belah = explode('-', trim(str_replace(" ", "",$objWorksheet->getCellByColumnAndRow(11, $row))));
                        $bagi = explode('-', trim(str_replace(" ", "",$objWorksheet->getCellByColumnAndRow(12, $row))));
                        $waktu = [
                            "TMT_CPNS" => $belah[2]."-".$belah[1]."-".$belah[0],
                            "TMT_KERJA" => $bagi[2]."-".$bagi[1]."-".$bagi[0],
                        ];
                        
                        $datapangkat = [
                            'TRGOLONGAN_ID' => trim(str_replace(" ", "",$objWorksheet->getCellByColumnAndRow(23, $row))),
                            'NO_SK' => trim(str_replace(" ", "",$objWorksheet->getCellByColumnAndRow(22, $row)))
                        ];
                        
                        $datapangkattanggal = [
                            "TMT_GOL" => $belah[2]."-".$belah[1]."-".$belah[0],
                            "TGL_SK" => $mecah[2]."-".$mecah[1]."-".$mecah[0]
                        ];
                        
                        if ($this->master_pegawai_cpns_model->update($cpns, $waktu, $data_pegawai['ID'])) {
                            $data_pegawai = $this->master_pegawai_model->get_by_nipnew_select(str_replace("'", "",trim($objWorksheet->getCellByColumnAndRow(1, $row))), "ID,NIP,NIPNEW");
                            
                            $this->master_pegawai_cpns_model->save_pangkat($datapangkat, $datapangkattanggal, $data_pegawai['ID']);
                            
                            $getjabatan = $this->master_pegawai_jabatan_model->nama_jabatan($kodejabatan);
                            $nmjabatan = '';
...
//                            echo $nmpnsnmunit."<br />"."<br />".$data_pegawai['ID']."<br />";
                            $datajab = [
                                "TRESELON_ID" => str_replace("'", "",ltrim(rtrim($objWorksheet->getCellByColumnAndRow(13, $row)))),
                                "TRJABATAN_ID" => $kodejabatan,
                                'TMPEGAWAI_ID' => $data_pegawai['ID'],
                                'TRLOKASI_ID' => $lokasi,
                                'KDU1' => $kdu1,
                                'KDU2' => $kdu2,
                                'KDU3' => $kdu3,
                            ...
                            $tanggaljab = [
                                "TMT_JABATAN" => $belah[2]."-".$belah[1]."-".$belah[0],
                                "TGL_SK" => $mecah[2]."-".$mecah[1]."-".$mecah[0],
                            ];
                            
                            if ($this->master_pegawai_jabatan_model->count_is_pns($data_pegawai['ID'], str_replace("'", "",trim(str_replace(" ", "",$objWorksheet->getCellByColumnAndRow(22, $row)))), str_replace("-", "/",trim(str_replace(" ", "",$objWorksheet->getCellByColumnAndRow(11, $row)))), str_replace("-", "/",trim(str_replace(" ", "",$objWorksheet->getCellByColumnAndRow(21, $row))))) < 1) {
                                $this->master_pegawai_jabatan_model->insert($datajab, $tanggaljab);
                            }
                        }
                        $sukses++;
                    } else {
    ...
    public function format_excel_cpns() {
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L1', 'TMT Cpns');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M1', 'TMT Kerja');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('N1', 'Eselon');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('O1', 'Jabatan');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('P1', 'Lokasi Kerja');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Q1', 'Unit Jabatan Pimpinan Tinggi Madya');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('R1', 'Unit Jabatan Pimpinan Tinggi Pratama');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('S1', 'Unit Jabatan Administrator');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('T1', 'Unit Pengawas');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('U1', 'Unit Pelaksana (Eselon V)');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('V1', 'TGL SK');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('W1', 'NO SK');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('X1', 'Pangkat');
        ...
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('L2', '30 - 08 - 2019');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('M2', '30 - 08 - 2019');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('V2', '30 - 08 - 2019');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y2', '<-- Contoh');
        $objPHPExcel->setActiveSheetIndex(0)->setCellValue('Y3', '<-- Mulai di-sini');
        ...
        $objPHPExcel->getActiveSheet()->getColumnDimension('R')->setWidth(38);
        ...
        $objPHPExcel->getActiveSheet()->getStyle('A1:X1')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_TOP);
        $objPHPExcel->getActiveSheet()->getStyle('A2:Y2')->applyFromArray($styleMerah);
        $objPHPExcel->getActiveSheet()->getStyle('L2:Y2')->applyFromArray($styleMerah);
        $objPHPExcel->getActiveSheet()->getStyle('A1:X1')->applyFromArray($styleHeaderTable);
        ...
        $list_eselon = $this->list_model->list_eselon();
        $list_eselon_jabatan = $this->list_model->list_eselon_jabatan();
        $list_lokasi = $this->list_model->list_lokasi();
        $list_kdu = $this->list_model->list_kdu();
        $list_golongan = $this->list_model->list_golongan_pangkat();
        ...
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('M1', 'Referensi Eselon');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('M2', 'Kode');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('N2', 'Nama');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('P1', 'Referensi Jabatan');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('P2', 'Kode Eselon');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('Q2', 'Nama Eselon');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('R2', 'Kode Jabatan');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('S2', 'Nama Jabatan');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('U1', 'Referensi Lokasi Kerja');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('U2', 'Kode');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('V2', 'Nama');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('X1', 'Referensi Unit Kerja');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('X2', 'Kode Lokasi Kerja');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('Y2', 'KDU1');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('Z2', 'KDU2');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('AA2', 'KDU3');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('AB2', 'KDU4');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('AC2', 'KDU5');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('AD2', 'Nama Unit Kerja');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('AF1', 'Referensi Pangkat Golongan');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('AF2', 'Kode');
        $objPHPExcel->setActiveSheetIndex(1)->setCellValue('AG2', 'Nama');
        ...
        $objPHPExcel->getActiveSheet()->getStyle('M2:N2')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('M2:N2')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_TOP);
        $objPHPExcel->getActiveSheet()->getStyle('M1:N1')->applyFromArray($styleHeader);
        $objPHPExcel->getActiveSheet()->getStyle('M2:N2')->applyFromArray($styleHeaderTable);
        $objPHPExcel->getActiveSheet()->mergeCells('P1:S1');
        $objPHPExcel->getActiveSheet()->getStyle('P2:S2')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('P2:S2')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_TOP);
        $objPHPExcel->getActiveSheet()->getStyle('P1:P1')->applyFromArray($styleHeader);
        $objPHPExcel->getActiveSheet()->getStyle('P2:P2')->applyFromArray($styleHeaderTable);
        $objPHPExcel->getActiveSheet()->mergeCells('U1:V1');
        $objPHPExcel->getActiveSheet()->getStyle('U2:V2')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('U2:V2')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_TOP);
        $objPHPExcel->getActiveSheet()->getStyle('U1:V1')->applyFromArray($styleHeader);
        $objPHPExcel->getActiveSheet()->getStyle('U2:V2')->applyFromArray($styleHeaderTable);
        $objPHPExcel->getActiveSheet()->mergeCells('X1:AD1');
        $objPHPExcel->getActiveSheet()->getStyle('X2:AD2')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('X2:AD2')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_TOP);
        $objPHPExcel->getActiveSheet()->getStyle('X1:AD1')->applyFromArray($styleHeader);
        $objPHPExcel->getActiveSheet()->getStyle('X2:AD2')->applyFromArray($styleHeaderTable);
        $objPHPExcel->getActiveSheet()->getStyle('AF2:AG2')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('AF2:AG2')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_TOP);
        $objPHPExcel->getActiveSheet()->getStyle('AF1:AG1')->applyFromArray($styleHeader);
        $objPHPExcel->getActiveSheet()->getStyle('AF2:AG2')->applyFromArray($styleHeaderTable);
        ...
        $row = 3;
        foreach ($list_eselon as $rowj) {
            $objPHPExcel->setActiveSheetIndex(1)->setCellValue('M' . $row, "'".$rowj['ID'])->setCellValue('N' . $row, $rowj['NAMA']);
            $row++;
        }
        
        $row = 3;
        foreach ($list_eselon_jabatan as $rowj) {
            $objPHPExcel->setActiveSheetIndex(1)->setCellValue('P' . $row, "'".$rowj['KODE'])
            ->setCellValue('Q' . $row, $rowj['ESELON'])->setCellValue('R' . $row, "'".$rowj['ID'])
            ->setCellValue('S' . $row, $rowj['NAMAJABATAN']);
            $row++;
        }
        
        $row = 3;
        foreach ($list_lokasi as $rowj) {
            $objPHPExcel->setActiveSheetIndex(1)->setCellValue('U' . $row, $rowj['ID'])->setCellValue('V' . $row, $rowj['NAMA']);
            $row++;
        }
        
        $row = 3;
        foreach ($list_kdu as $rowj) {
            $objPHPExcel->setActiveSheetIndex(1)->setCellValue('X' . $row, $rowj['TRLOKASI_ID'])
            ->setCellValue('Y' . $row, "'".$rowj['KDU1'])
            ->setCellValue('Z' . $row, "'".$rowj['KDU2'])
            ->setCellValue('AA' . $row, "'".$rowj['KDU3'])
            ->setCellValue('AB' . $row, "'".$rowj['KDU4'])
            ->setCellValue('AC' . $row, "'".$rowj['KDU5'])
            ->setCellValue('AD' . $row, $rowj['NAMA']);
            $row++;
        }
        
        $row = 3;
        foreach ($list_golongan as $rowj) {
            $objPHPExcel->setActiveSheetIndex(1)->setCellValue('AF' . $row, "'".$rowj['ID'])->setCellValue('AG' . $row, $rowj['NAMA']);
            $row++;
        }
