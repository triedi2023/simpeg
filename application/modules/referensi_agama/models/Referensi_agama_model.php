...
class Referensi_agama_model extends CI_Model {
    ...
    private $tabel = "TR_AGAMA";
    private $column_order = array(null, 'AGAMA', 'STATUS'); //set column field database for datatable orderable
    ...
    public function next_val_id() {
        return $this->db->query("SELECT TR_AGAMA_SEQ.NEXTVAL AS NEXT_ID FROM DUAL")->row_array();
    }
