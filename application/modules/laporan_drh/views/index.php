                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-content-inner">
                            <div class="m-heading-1 border-green m-bordered">
                                <h3>Parameter</h3>
                                <div class="form">
                                    <form action="#" class="form-horizontal" id="formpencarian" data-url="<?php echo site_url("laporan_drh/pencarian_proses") ?>">
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="text" name="nip" maxlength="20" id="nip" class="form-control" readonly="" placeholder="NIP Pegawai" />
                                                        </div>
                                                        <div class="col-md-3" id="tampungnama" style="vertical-align:middle;width: auto;line-height: 2.5"></div>
                            ...
                            <div class="hasilfilter" style="display: none"></div>
                        </div>
