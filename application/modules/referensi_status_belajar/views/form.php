<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('referensi_status_belajar/ubah_proses?id='.$id) : site_url('referensi_status_belajar/tambah_proses')]); ?>
            <div class="form-body">
                
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label">Status Belajar <span class="required" aria-required="true"> * </span></label>
                            <input type="text" name="status_belajar" id="field_cr_status_belajar" class="form-control" value="<?php echo isset($id) ? $model->STATUS_BELAJAR : set_value('status_belajar'); ?>" placeholder="Status Belajar" />
                        </div>
                    </div>
                    <!--/span-->
                    <div class="col-md-6">
