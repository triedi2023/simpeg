<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('referensi_penjenjangan_fungsional/ubah_proses?id='.$id) : site_url('referensi_penjenjangan_fungsional/tambah_proses')]); ?>
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="penjenjangan" id="field_cr_penjenjangan" class="form-control" value="<?php echo isset($id) ? $model->PENJENJANGAN_FUNGSIONAL : set_value('penjenjangan'); ?>" maxlength="50" minlength="2" placeholder="<?=$title_utama;?>" />
                        </div>
                    </div>
                    <!--/span-->
                    <div class="col-md-6">
