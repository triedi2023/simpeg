        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                <div class="btn-group btn-group-devided" data-toggle="buttons">
                    ...
                    <a title="Cetak Excel" class="btn btn-transparent red btn-outline btn-circle btn-sm btnexportexcel" data-url="<?php echo site_url("daftar_masa_kerja_jabatan/export_excel") ?>">
                        <i class="fa fa-file-excel-o"></i> Excel
                    </a>
                    <a title="Cetak PDF" class="btn btn-transparent red btn-outline btn-circle btn-sm btnexportpdf" data-url="<?php echo site_url("daftar_masa_kerja_jabatan/export_pdf") ?>">
                                    ...
                                    <td class="text-left">
                                        <?php if ($val['DIKLATPIM']): ?>
                                            ...
                                            <?php foreach ($val['DIKLATPIM'] as $diklat): ?>
                                                <li class="text-left"><?php echo $diklat['NAMA_JENJANG'] ?></li>
                                            <?php endforeach ?>
                                            </ol>
                                        <?php endif; ?>
                                    </td>
