<?php if ($_POST['action'] == 'select_lok') { ?>
    0[[SPLIT]] 
    <select name="kdu1" id="kdu1" style="max-width: none;width: 225px;">
        ...
        <?php foreach ($list_struktur_es1 as $r) { ?>
            <option value="<?php echo $r['kdu1']; ?>"><?php echo $r['nmunit']; ?></option>
        <?php } ?>
    </select>
<?php } ?>
[[SPLIT]] 
    ...
    <div class="menteri" style="width:<?= $class_width ?>px;">
        ...
        <div class="box_item">
            <div class="item_menteri">
                <div class="right">
                    <h2 style="color:#fff"><?= "MENTERI PERHUBUNGAN" ?></h2>
                    ...
                    <div class="item_spesial_l color-<?= $leher_l[0]['tktesel'] ?>">
                        ...
                        <a href="<?= base_url() ?><?= $leher_l[0]['url_link'] ?>?keepThis=true&type=image&TB_iframe=1&width=1024&height=566&modal=true"  class="thickbox "> 
                            ...
                            <div class="desc">
                                ...
                                <h3>NIP.&nbsp;<?= $leher_l[0]['nip'] ?></h3>
                                <h3>Eselon. / TMT. <?= $leher_l[0]['tmtjab'] ?></h3>
                                <h3>Lhr. <?= $leher_l[0]['tgllahir'] ?></h3>
                                <?php
                                $masajab = "";
                    ...
                    <div class="item_spesial_r color-<?= $leher_r[0]['tktesel'] ?>">
                        ...
                        <a href="<?= base_url() ?><?= $leher_r[0]['url_link'] ?>?keepThis=true&type=image&TB_iframe=1&width=1024&height=566&modal=true"  class="thickbox "> 
                            ...
                            <div class="desc">
                                ...
                                <h3>NIP.&nbsp;<?= $leher_r[0]['nip'] ?></h3>
                                <h3>Eselon. / TMT. <?= $leher_r[0]['tmtjab'] ?></h3>
                                <h3>Lhr. <?= $leher_r[0]['tgllahir'] ?></h3>
                                <?php
                                $masajab = "";
