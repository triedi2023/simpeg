<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('referensi_negara/ubah_proses?id='.$id) : site_url('referensi_negara/tambah_proses')]); ?>
            <div class="form-body">
                
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label">Nama Negara <span class="required" aria-required="true"> * </span></label>
                            <input type="text" name="negara" id="field_cr_negara" class="form-control" value="<?php echo isset($id) ? $model->NAMA_NEGARA : set_value('negara'); ?>" placeholder="Nama Negara" />
                        </div>
                    </div>
                    <!--/span-->
                    <div class="col-md-6">
