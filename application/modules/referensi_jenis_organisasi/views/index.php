                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="search_jenis_organisasi" placeholder="<?= $title_utama ?>" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="portlet box blue-dark">
                                        ...
                                        <div class="portlet-body">
                                            <div class="table-container" data-url="<?php echo site_url('referensi_jenis_organisasi/ajax_list') ?>">
