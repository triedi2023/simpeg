                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="agama" id="search_agama" class="form-control" value="" placeholder="Agama" />
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="portlet box blue-dark">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-th"></i> Daftar Pegawai BSG
                                            </div>
                                            <div class="actions"></div>
                                        </div>
                                        <div class="portlet-body">
                                            <div class="table-container" data-url="<?php echo site_url('daftar_pegawai_bsg/ajax_list') ?>">
