<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('referensi_fakultas/ubah_proses?id='.$id) : site_url('referensi_fakultas/tambah_proses')]); ?>
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_fakultas" id="field_cr_nama_fakultas" class="form-control" value="<?php echo isset($id) ? $model->NAMA_FAKULTAS : set_value('tingkat_pendidikan'); ?>" maxlength="50" minlength="2" placeholder="Nama <?=$title_utama;?>" />
                        </div>
                    </div>
                    <!--/span-->
                    <div class="col-md-6">
