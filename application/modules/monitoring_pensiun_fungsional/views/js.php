<script type="text/javascript">
    ...
    $('body').on('submit', "form#formpencarian", function (e) {
        ...
        $.ajax({
            ...
            kdu5_id:$("select#search_kdu5").val(),gol_pangkat:$("select#gol_pangkat").val(),
    ...
    $('body').on('click', "a.btnexport", function (e) {
        ...
        '&gol_pangkat='+$("select#gol_pangkat").val()+'&bulan1='+$("select#bulan1").val()+'&tahun1='+$("select#tahun1").val()+'&bulan2='+$("select#bulan2").val()+'&tahun2='+$("select#tahun2").val());
        return false;
    });
</script>