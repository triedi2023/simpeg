...
class Monitoring_pensiun_fungsional_model extends CI_Model {
    ...
    function get_data($lok='2',$kdu1='00',$kdu2='00',$kdu3='000',$kdu4='000',$kdu5='00',$gol_pangkat="",$bulan="",$tahun='',$bulan1="",$tahun1='') {
        ...
        $sql = "SELECT VMP.*,TTP.TINGKAT_PENDIDIKAN FROM V_MONITORING_PENSIUN VMP LEFT JOIN V_PEGAWAI_PENDIDIKAN_MUTAKHIR VPPM ON (VPPM.TMPEGAWAI_ID=VMP.ID) LEFT JOIN 
        TR_TINGKAT_PENDIDIKAN TTP ON (TTP.ID=VPPM.TRTINGKATPENDIDIKAN_ID)
        WHERE TRESELON_ID <> '17' AND TRESELON_ID IN ('13','15') $where ORDER BY TMT_PENSIUN ASC";
