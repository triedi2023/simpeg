<script type="text/javascript">
    ...
    $('body').on('click', '.popuplarge', function (e) {
        ...
        var datanyanih = {nmjabatan: $(this).attr('data-nmjabatan'), jabatan: $(this).attr('data-jabatan'), lokasi_id: $(this).attr('data-lok'), kdu1_id: $(this).attr('data-kdu1'), kdu2_id: $(this).attr('data-kdu2'), kdu3_id: $(this).attr('data-kdu3'), kdu4_id: $(this).attr('data-kdu4'), kdu5_id: $(this).attr('data-kdu5')};
