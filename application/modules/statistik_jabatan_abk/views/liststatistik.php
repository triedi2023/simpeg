<div class="modal-header bg-yellow-soft bg-font-yellow-soft" style="padding: 10px">
    ...
    <h4 class="modal-title bg-font-blue-madison font-lg sbold pull-left">Daftar Jabatan <?php echo $nmjabatan; ?></h4>
</div>
<div class="modal-body">
    ...
    <div class="panel-success">
        <div class="table-container" data-url="<?php echo site_url('statistik_jabatan_abk/ajax_liststatistik') ?>">
...
<script>
    var datasearch = function (data) {
        data.jabatan = '<?php echo ($jabatan) ? $jabatan : '' ?>';
        data.nmjabatan = '<?php echo ($nmjabatan) ? $nmjabatan : '' ?>';
    ...
    var $popuplistpegawai = $('table.popuplistpegawai').DataTable({
        ...
        processing: true,
        ajax: {
            url: '<?php echo site_url('statistik_jabatan_abk/ajax_liststatistik') ?>',
            type: 'POST',
            data: datasearch
        }
    });
