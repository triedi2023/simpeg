<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('referensi_kualifikasi_kelulusan/ubah_proses?id=' . $id) : site_url('referensi_kualifikasi_kelulusan/tambah_proses')]); ?>
            <div class="form-body">

                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label">Kualifikasi Kelulusan <span class="required" aria-required="true"> * </span></label>
                            <input type="text" name="kualifikasi_kelulusan" id="field_cr_kualifikasi_kelulusan" class="form-control" value="<?php echo isset($id) ? $model->KUALIFIKASI_KELULUSAN : set_value('kualifikasi_kelulusan'); ?>" placeholder="Kondisi Belajar" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
