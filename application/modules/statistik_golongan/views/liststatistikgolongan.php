<div class="modal-header bg-yellow-soft bg-font-yellow-soft" style="padding: 10px">
    ...
    <h4 class="modal-title bg-font-blue-madison font-lg sbold pull-left">Daftar Golongan <?php echo $golongan; ?></h4>
</div>
<div class="modal-body">
    ...
    <div class="panel-success">
        <div class="table-container" data-url="<?php echo site_url('statistik_golongan/ajax_liststatistikgolongan') ?>">
...
<script>
    var datasearch = function (data) {
        data.golongan = '<?php echo ($golongan) ? $golongan : '' ?>';
    ...
    var $popuplistpegawai = $('table.popuplistpegawai').DataTable({
        ...
        processing: true,
        ajax: {
            url: '<?php echo site_url('statistik_golongan/ajax_liststatistikgolongan') ?>',
            type: 'POST',
            data: datasearch
        }
    });
