                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-content-inner">
                            <div class="m-heading-1 border-green m-bordered">
                                <h3>Parameter</h3>
                                <div class="form">
                                    <form action="#" class="form-horizontal" id="formpencarian" data-url="<?php echo site_url("monitoring_kp_fungsional/pencarian_proses") ?>">
                                        <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-7">
                                                            <select name="jenis_pangkat" id="jenis_pangkat" class="form-control" style="width: 100%">
                                                                <option value="1">&nbsp;Khusus Fungsional</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
