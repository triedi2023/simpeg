        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                <div class="btn-group btn-group-devided" data-toggle="buttons">
                    ...
                    <a class="btn btn-transparent red btn-outline btn-circle btn-sm btnexport" data-url="<?php echo site_url("monitoring_kp_fungsional/export_excel") ?>">
                        <i class="fa fa-file-excel-o"></i> Excel
                    </a>
                    <a class="btn btn-transparent red btn-outline btn-circle btn-sm btnexport" data-url="<?php echo site_url("monitoring_kp_fungsional/export_pdf") ?>">
                        ...
                        <?php if ($model): ?>
                            ...
                            foreach ($model as $val):
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo $val['TEXT_GOLONGAN_LAMA']."<br />".$val['TMT_GOL_LAMA'] ?> </td>
                                    <td> <?php echo $val['TEXT_GOLONGAN_BARU']."<br />".$val['TMT_GOL_BARU'] ?> </td>
                                    <td> <?php echo ''; ?> </td>
                                </tr>
                                <?php
                                $t++;
