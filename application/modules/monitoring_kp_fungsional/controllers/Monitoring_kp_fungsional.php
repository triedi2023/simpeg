...
class Monitoring_kp_fungsional extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('monitoring_kp_fungsional/monitoring_kp_fungsional_model', 'list_model'));
        $this->load->helper(array('form', 'app_helper'));
        $this->data['plugin_js'] = ['assets/plugins/select2/js/select2.full.min.js'];
        $this->data['custom_js'] = ['monitoring_kp_fungsional/js', 'system/unitkerja_form-horizontal_filter_js'];
        $this->data['title_utama'] = 'Monitoring Kenaikan Pangkat';
    }

    public function index() {
        $this->data['content'] = 'monitoring_kp_fungsional/index';
    ...
    public function pencarian_proses() {
        ...
        $this->data['model'] = $this->monitoring_kp_fungsional_model->get_data($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5,$jenis_pangkat,$gol_pangkat,$bulan,$tahun);
        $this->data['struktur'] = $this->monitoring_kp_fungsional_model->get_struktur($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5);
        
        $this->load->view("monitoring_kp_fungsional/_hasil", $this->data);
    }
    ...
    public function export_excel() {
        ...
        $model = $this->monitoring_kp_fungsional_model->get_data($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5,$jenis_pangkat,$gol_pangkat,$bulan,$tahun);
        $struktur = $this->monitoring_kp_fungsional_model->get_struktur($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5);
        $jumlah = count($model);
        ...
        if ($model) {
            foreach ($model as $val) {
                ...
                $objPHPExcel->setActiveSheetIndex(0)
                        ...
                        ->setCellValue('E' . $j, $val['TEXT_GOLONGAN_LAMA']."\n".$val['TMT_GOL_LAMA'])
                        ->setCellValue('F' . $j, $val['TEXT_GOLONGAN_BARU']."\n".$val['TMT_GOL_BARU'])
                        ->setCellValue('G' . $j, '');
    ...
    public function export_pdf() {
        ...
        $this->data['model'] = $this->monitoring_kp_fungsional_model->get_data($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5,$jenis_pangkat,$gol_pangkat,$bulan,$tahun);
        $this->data['struktur'] = $this->monitoring_kp_fungsional_model->get_struktur($lokasi_id,$kdu1,$kdu2,$kdu3,$kdu4,$kdu5);
        $this->data['content'] = 'monitoring_kp_fungsional/pdf';
