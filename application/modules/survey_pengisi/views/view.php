                                                ...
                                                <div class="portlet-body">
                                                    <?php if ($val['hasil']): ?>
                                                        ...
                                                        <?php foreach ($val['hasil'] as $hasil): ?>
                                                            <div class="progress">
                                                                <div class="progress-bar progress-bar-success <?php echo $color[$j] ?>" role="progressbar" aria-valuenow="<?php echo ($hasil['CAPAIAN'] * 100) / $hasiltotal; ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo ($hasil['CAPAIAN'] * 100) / $hasiltotal; ?>%">
                                                                    <span class="sr-only"> <?php echo ($hasil['CAPAIAN'] * 100) / $hasiltotal; ?>% Complete (success) </span> <?php echo $hasil['JAWABAN'] ?> ( <?php echo ($hasil['CAPAIAN'] * 100) / $hasiltotal; ?>% )
                                                                </div>
                                                            </div>
                                                            <?php
                                                            $j++;
