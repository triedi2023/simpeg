<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('referensi_status_pernikahan/ubah_proses?id='.$id) : site_url('referensi_status_pernikahan/tambah_proses')]); ?>
            <div class="form-body">
                
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label">Kode <span class="required" aria-required="true"> * </span></label>
                            <input type="text" name="kode" id="field_cr_kode" class="form-control" <?php echo isset($id) ? 'disabled="disabled"' : set_value('kode'); ?> value="<?php echo isset($id) ? $model->ID : set_value('kode'); ?>" placeholder="Kode" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama" id="field_cr_nama" class="form-control" value="<?php echo isset($id) ? $model->NAMA : set_value('nama'); ?>" placeholder="Status" />
                        </div>
                    </div>
                    <!--/span-->
                    <div class="col-md-4">
