                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">Tipe Pangkat</label>
                                            <select name="tipe_pangkat" id="search_tipe_pangkat" class="form-control" style="width: 100%">
                                                <option value="">- Pilih -</option>
                                                <?php if ($list_status_kepegawaian): ?>
                                                    <?php echo $list_status_kepegawaian; ?>
                                                <?php endif ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="search_golongan" placeholder="level" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="control-label">Pangkat</label>
                                            <input type="text" id="search_pangkat" placeholder="level" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="portlet box blue-dark">
                                        ...
                                        <div class="portlet-body">
                                            <div class="table-container" data-url="<?php echo site_url('referensi_pangkat/ajax_list') ?>">
                                                <table class="defaultgridview table table-striped table-bordered table-hover order-column dataTable no-footer">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center" style="width: 10%"> No </th>
                                                            <th class="text-center">Tipe Pangkat</th>
                                                            <th class="text-center">Golongan</th>
                                                            <th class="text-center">Pangkat</th>
                                                            <th class="text-center">Kesetaraan</th>
