...
class Ppo_bkn_model extends CI_Model {

    private $tabel = "TH_PPO_BKN";
    private $column_order = array(null, "NAMA", "NIPNEW", 'TMT_PENSIUN', 'TMT_GOLONGAN', 'GOLONGAN', "NO_SK", 'TGL_SK'); //set column field database for datatable orderable
    ...
    private function _get_datatables_query() {
        ...
        $this->db->select("TH_PPO_BKN.ID,NAMA,TP.NIPNEW,NO_SK,TO_CHAR(TGL_SK,'DD/MM/YYYY') as TGL_SK2,TO_CHAR(TMT_PENSIUN,'DD/MM/YYYY') as TMT_PENSIUN2,TRG.GOLONGAN,TO_CHAR(TMT_GOLONGAN,'DD/MM/YYYY') as TMT_GOLONGAN2,TRG.PANGKAT,TP.ID AS IDPEGAWAI");
        $this->db->from($this->tabel);
        $this->db->join("TR_GOLONGAN TRG","TRG.ID_BKN=TH_PPO_BKN.GOLONGAN_ID AND TRG.TRSTATUSKEPEGAWAIAN_ID='1'","LEFT JOIN");
        $this->db->join("TM_PEGAWAI TP","TP.NIPNEW=TH_PPO_BKN.NIPNEW","JOIN");
        $i = 0;
