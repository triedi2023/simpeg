                                    ...
                                    <div class="portlet box blue-dark">
                                        ...
                                        <div class="portlet-body">
                                            <form action="<?php echo site_url('integrasi_bkn/proses'); ?>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3"><h3>Data Pindah Instansi Simpeg</h3></div>
                                                    ...
                                                    <div class="col-md-3 text-right"><h3>Data Pindah Instansi BKN</h3></div>
                                                </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control">
                                                                        ...
                                                                        <input type="hidden" class="form-control" value="<?php echo isset($bkn[$i])?$bkn[$i]['skUsulNomor']:NULL; ?>" name="simpeg_no_sk[<?php echo isset($simpeg[$i]) ? (!empty($simpeg[$i]->ID) ? $simpeg[$i]->ID : '') : ''; ?>]" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>No SK</label>
                                                                    <div class="form-control">
                                                                        <?php echo isset($bkn[$i])?$bkn[$i]['skUsulNomor']:NULL; ?>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control">
                                                                        ...
                                                                        <input type="hidden" class="form-control" value="<?php echo isset($bkn[$i])? str_replace("-", '/',$bkn[$i]['skUsulTanggal']):NULL; ?>" name="simpeg_tgl_sk[<?php echo isset($simpeg[$i]) ? (!empty($simpeg[$i]->ID) ? $simpeg[$i]->ID : '') : ''; ?>]" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>Tgl SK</label>
                                                                    <div class="form-control">
                                                                        <?php echo isset($bkn[$i])? str_replace("-", '/',$bkn[$i]['skUsulTanggal']):NULL; ?>
