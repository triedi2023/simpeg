                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Tanggal Awal PPO</label>
                                            <input type="text" id="search_tgl_awal" placeholder="Tanggal Awal PPO" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Tanggal Akhir PPO</label>
                                            <input type="text" id="search_tgl_akhir" placeholder="Tanggal Akhir PPO" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="portlet box blue-dark">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-th"></i> Data PPO BKN <?= $title_utama ?> 
                                            </div>
                                            <div class="actions"></div>
                                        </div>
                                        <div class="portlet-body">
                                            <div class="table-container" data-url="<?php echo site_url('integrasi_bkn/ajax_list_pposk') ?>">
                                                <table class="defaultgridview table table-striped table-bordered table-hover order-column dataTable no-footer">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="text-center">TMT Golongan Terakhir</th>
                                                            <th class="text-center">Gol / Pangkat Terakhir</th>
