    ...
    <div class="form">
        ...
        <div class="form-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" name="tmt_golongan" id="field_cr_tmt_golongan" class="form-control" value="<?php echo isset($bkn['tmtGolongan']) ? str_replace("-", "/", $bkn['tmtGolongan']) : set_value('tmt_golongan'); ?>" placeholder="TMT Golongan" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-2">
                    <div class="input-group">
                        <input type="text" name="mk_thn" id="field_c_mk_thn" class="form-control" placeholder="0" value="<?php echo isset($bkn['masaKerjaGolonganTahun'])?$bkn['masaKerjaGolonganTahun']:null; ?>" />
                        <span class="input-group-addon">Thn.</span>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="input-group">
                        <input type="text" name="mk_bln" id="field_c_mk_bln" class="form-control" placeholder="0" value="<?php echo isset($bkn['masaKerjaGolonganBulan'])?$bkn['masaKerjaGolonganBulan']:null; ?>" />
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" name="tgl_sk" maxlength="100" id="field_cr_tgl_sk" class="form-control" value="<?php echo isset($bkn['skTanggal']) ? str_replace("-", "/", $bkn['skTanggal']) : set_value('tgl_sk'); ?>" placeholder="TGL SK" />
                </div>
            </div>
