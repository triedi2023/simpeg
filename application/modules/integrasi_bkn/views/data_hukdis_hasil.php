                                    ...
                                    <div class="portlet box blue-dark">
                                        ...
                                        <div class="portlet-body">
                                            ...
                                            <form action="<?php echo site_url('integrasi_bkn/proses'); ?>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3"><h3>Data Hukdis Simpeg</h3></div>
                                                    ...
                                                    <div class="col-md-3 text-right"><h3>Data Hukdis BKN</h3></div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control">
                                                                        <?php echo isset($simpeg[$i]->ALASAN_HKMN)?$simpeg[$i]->ALASAN_HKMN:NULL; ?>
                                                                        <input type="hidden" class="form-control" value="<?php echo isset($bkn[$i])?$bkn[$i]['alasanHukumanDisiplin']:NULL; ?>" name="simpeg_alasan[<?php echo isset($simpeg[$i]) ? (!empty($simpeg[$i]->ID) ? $simpeg[$i]->ID : '') : ''; ?>]" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control" style="background-color: #e9edef">
                                                                        <?php if ((isset($simpeg[$i]) && !empty($simpeg[$i]->ID)) && (isset($bkn[$i]) && !empty($bkn[$i]['id']))) { ?>
                                                                            <label class="mt-checkbox mt-checkbox-outline"> Alasan Hukuman
                                                                                <input type="checkbox" class="form-control" value="alasan" name="pilih[<?php echo isset($simpeg[$i]->ID) ? (!empty($simpeg[$i]->ID) ? $simpeg[$i]->ID : '') : ''; ?>][]" />
                                                                                <span style="border: 1px solid #000;"></span>
                                                                            </label>
                                                                        <?php } ?>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    <label>Alasan Hukuman</label>
                                                                    <div class="form-control">
                                                                        <?php echo isset($bkn[$i])?$bkn[$i]['alasanHukumanDisiplin']:NULL; ?>
                                                                        <input type="hidden" class="form-control" value="<?php echo isset($simpeg[$i]->ALASAN_HKMN)?$simpeg[$i]->ALASAN_HKMN:NULL; ?>" name="bkn_alasan[<?php echo isset($simpeg[$i]) ? (!empty($simpeg[$i]->ID) ? $simpeg[$i]->ID : '') : ''; ?>]" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
