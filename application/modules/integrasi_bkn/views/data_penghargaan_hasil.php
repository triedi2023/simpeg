                                    ...
                                    <div class="portlet box blue-dark">
                                        ...
                                        <div class="portlet-body">
                                            <form action="<?php echo site_url('integrasi_bkn/proses'); ?>" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3"><h3>Data Penghargaan Simpeg</h3></div>
                                                    ...
                                                    <div class="col-md-3 text-right"><h3>Data Penghargaan BKN</h3></div>
                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    <label>Jenis Tanda Jasa</label>
                                                                    <div class="form-control">
                                                                        <?php echo isset($simpeg[$i]->NAMA_BKN)?$simpeg[$i]->NAMA_BKN:NULL; ?>
                                                                        <input type="hidden" class="form-control" value="<?php echo isset($bkn[$i])?$bkn[$i]['jenisHarga']:NULL; ?>" name="simpeg_jenis[<?php echo isset($simpeg[$i]) ? (!empty($simpeg[$i]->ID) ? $simpeg[$i]->ID : '') : ''; ?>]" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control" style="background-color: #e9edef">
                                                                        <?php if ((isset($simpeg[$i]) && !empty($simpeg[$i]->ID)) && (isset($bkn[$i]) && !empty($bkn[$i]['id']))) { ?>
                                                                            <label class="mt-checkbox mt-checkbox-outline"> Jenis Tanda Jasa
                                                                                <input type="hidden" class="form-control" value="data_penghargaan" name="integrasi" />
                                                                                ...
                                                                                <input type="checkbox" class="form-control" value="jenis_tdjasa" name="pilih[<?php echo isset($simpeg[$i]) ? (!empty($simpeg[$i]->ID) ? $simpeg[$i]->ID : '') : ''; ?>][]" />
                                                            ...
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    <label>Jenis Tanda Jasa</label>
                                                                    <div class="form-control">
                                                                        <?php echo isset($bkn[$i])?$bkn[$i]['namaHarga']:NULL; ?>
                                                                        <input type="hidden" class="form-control" value="<?php echo isset($simpeg[$i]->ID_BKN)?$simpeg[$i]->ID_BKN:NULL; ?>" name="bkn_jenis[<?php echo isset($simpeg[$i]) ? (!empty($simpeg[$i]->ID) ? $simpeg[$i]->ID : '') : ''; ?>]" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    <label>Tahun</label>
                                                                    <div class="form-control">
                                                                        <?php echo isset($simpeg[$i]->THN_PRLHN)?$simpeg[$i]->THN_PRLHN:NULL; ?>
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control" style="background-color: #e9edef">
                                                                        <?php if ((isset($simpeg[$i]) && !empty($simpeg[$i]->ID)) && (isset($bkn[$i]) && !empty($bkn[$i]['id']))) { ?>
                                                                            <label class="mt-checkbox mt-checkbox-outline"> Tahun
                                                            ...
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control">
                                                                        ...
                                                                        <input type="hidden" class="form-control" value="<?php echo isset($simpeg[$i]->THN_PRLHN)?$simpeg[$i]->THN_PRLHN:NULL; ?>" name="bkn_thn[<?php echo isset($simpeg[$i]) ? (!empty($simpeg[$i]->ID) ? $simpeg[$i]->ID : '') : ''; ?>]" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    <label>Nomor</label>
                                                                    <div class="form-control">
                                                                        <?php echo isset($simpeg[$i]->NOMOR)?$simpeg[$i]->NOMOR:NULL; ?>
                                                                        <input type="hidden" class="form-control" value="<?php echo isset($bkn[$i])?$bkn[$i]['skNomor']:NULL; ?>" name="simpeg_nomor[<?php echo isset($simpeg[$i]) ? (!empty($simpeg[$i]->ID) ? $simpeg[$i]->ID : '') : ''; ?>]" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-2">
                                                            ...
                                                            <div class="col-md-5">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="form-control">
                                                                        ...
                                                                        <input type="hidden" class="form-control" value="<?php echo isset($simpeg[$i]->NOMOR)?$simpeg[$i]->NOMOR:NULL; ?>" name="bkn_nomor[<?php echo isset($simpeg[$i]) ? (!empty($simpeg[$i]->ID) ? $simpeg[$i]->ID : '') : ''; ?>]" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        
                                                        <?php if (empty($simpeg[$i]->NAMA_BKN) && !empty($bkn[$i]['namaHarga'])): ?>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
                                                                        <button type="button" class="btn btn-block yellow-crusta popuplarge" data-url="<?php echo site_url('integrasi_bkn/tambah_penghargaan_form?ambil='.(isset($bkn[$i]['id']) ? $bkn[$i]['id'] : null)) ?>" data-id="<?php echo $pegawaiid ?>"><i class="m-icon-swapleft m-icon-white"></i> Tambahkan Ke Simpeg</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        <?php endif; ?>
