                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Tanggal Awal PPO Wafat Hist</label>
                                            <input type="text" id="search_tgl_awal" placeholder="Tanggal Awal PPO Wafat" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Tanggal Akhir PPO Wafat Hist</label>
                                            <input type="text" id="search_tgl_akhir" placeholder="Tanggal Akhir PPO Wafat" class="form-control" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="portlet box blue-dark">
                                        <div class="portlet-title">
                                            <div class="caption">
                                                <i class="fa fa-th"></i> Data PPO Wafat BKN <?= $title_utama ?> 
                                            </div>
                                            <div class="actions"></div>
                                        </div>
                                        <div class="portlet-body">
                                            <div class="table-container" data-url="<?php echo site_url('integrasi_bkn/ajax_list_ppowafat') ?>">
                                                <table class="defaultgridview table table-striped table-bordered table-hover order-column dataTable no-footer">
                                                    <thead>
                                                        <tr>
                                                            <th class="text-center" style="width: 10%"> No </th>
                                                            <th class="text-center">NIPNEW</th>
                                                            <th class="text-center">Nama</th>
                                                            <th class="text-center">Jenis Pensiun</th>
                                                            <th class="text-center">Tgl Meninggal</th>
                                                            <th class="text-center">Akte Meninggal</th>
