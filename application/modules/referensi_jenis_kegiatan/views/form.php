<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('referensi_jenis_kegiatan/ubah_proses?id=' . $id) : site_url('referensi_jenis_kegiatan/tambah_proses')]); ?>
            <div class="form-body">

                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label">Jenis Kegiatan <span class="required" aria-required="true"> * </span></label>
                            <input type="text" name="jenis_kegiatan" id="field_cr_jenis_kegiatan" class="form-control" value="<?php echo isset($id) ? $model->JENIS_KEGIATAN : set_value('jenis_kegiatan'); ?>" placeholder="Jenis Kegiatan" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
