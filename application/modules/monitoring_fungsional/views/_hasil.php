...
<div class="col-md-12">
    ...
    <div class="portlet light ">
        <div class="portlet-title">
            ...
            <div class="actions">
                <div class="btn-group btn-group-devided" data-toggle="buttons">
                    ...
                    <a class="btn btn-transparent red btn-outline btn-circle btn-sm btnexport" data-url="<?php echo site_url("monitoring_fungsional/export_excel") ?>">
                        <i class="fa fa-file-excel-o"></i> Excel
                    </a>
                    <a class="btn btn-transparent red btn-outline btn-circle btn-sm btnexport" data-url="<?php echo site_url("monitoring_fungsional/export_pdf") ?>">
        ...
        <div class="portlet-body">
            <h1 class="text-center">Monitoring Jabatan Fungsional</h1>
            <?php echo $nmstruktur; ?>
                ...
                <table class="table table-bordered table-hover table-striped table-advance">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left" style="width: 20%"> Nama / NIP </th>
                            <th class="text-left" style="width: 15%"> Gol / Ruang </th>
                        ...
                        <?php if ($model): ?>
                            ...
                            foreach ($model as $val):
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo $nama."<br />".$val['NIPNEW'] ?> </td>
                                    <td> <?php echo $val['PANGKAT']." (".$val['GOLONGAN'].") " ?> </td>
                                    <td> <?php echo $val['JABATAN']."<br />"."a. ".$val['TMT_JABATAN'] ?> </td>
                                    <td> <?php echo $val['MK_THN_TOTAL']." Tahun ".$val['MK_BLN_TOTAL']." Bulan" ?> </td>
                                    <td> <?php echo $val['STATUS_FUNGSIONAL'] ?> </td>
                                </tr>
                                <?php
                                $t++;
                            endforeach
