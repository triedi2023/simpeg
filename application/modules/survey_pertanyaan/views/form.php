<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('survey_pertanyaan/ubah_proses?id=' . $id) : site_url('survey_pertanyaan/tambah_proses')]); ?>
            <div class="form-body">
...
//                                        $selected = 'selected=""';
                ...
                <?php if (isset($pertanyaan)): ?>
                    <?php foreach ($pertanyaan as $tanya): ?>
                        <div class="row data_number" data-number="0">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <label class="control-label">Pertanyaan <span class="required" aria-required="true"> * </span></label>
                                            <input type="text" name="pertanyaan[0]" id="field_cr_pertanyaan" class="form-control" value="<?php echo $tanya['PERTANYAAN']; ?>" placeholder="Pertanyaan" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-11">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="jawaban[0][]" id="field_cr_jawaban" class="form-control" value="<?php echo $wab['JAWABAN'] ?>" placeholder="Jawaban">
                                                </div>
                                            </div>
                                            <div class="col-md-1 text-center">
                                                <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="form-group">
                                    <label class="control-label">Pertanyaan <span class="required" aria-required="true"> * </span></label>
                                    <input type="text" name="pertanyaan[0]" id="field_cr_pertanyaan" class="form-control" value="" placeholder="Pertanyaan" />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
