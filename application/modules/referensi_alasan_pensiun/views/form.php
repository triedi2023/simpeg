<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('referensi_alasan_pensiun/ubah_proses?id='.$id) : site_url('referensi_alasan_pensiun/tambah_proses')]); ?>
            <div class="form-body">
                
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label">Alasan Pensiun <span class="required" aria-required="true"> * </span></label>
                            <input type="text" name="alasan" id="field_cr_alasan" class="form-control" value="<?php echo isset($id) ? $model->ALASAN : set_value('alasan'); ?>" placeholder="Alasan Pensiun" />
                        </div>
                    </div>
                    <!--/span-->
                    <div class="col-md-6">
