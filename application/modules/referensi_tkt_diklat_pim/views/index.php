                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="search_jenjang" placeholder="Jenjang" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label">Level</label>
                                            <input type="text" id="search_level" placeholder="level" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <div class="portlet box blue-dark">
                                        ...
                                        <div class="portlet-body">
                                            <div class="table-container" data-url="<?php echo site_url('referensi_tkt_diklat_pim/ajax_list') ?>">
