<div class="col-md-12">
    <div class="portlet box yellow-gold">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-gift"></i>Form <?=$title_form;?> Referensi <?=$title_utama?> Eselon 5
            </div>
            <div class="tools">&nbsp;</div>
        </div>
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdatestruktur5 horizontal-form", 'data-url' => isset($id) ? site_url('referensi_struktur/ubah_proses?id='.$id) : site_url('referensi_struktur/tambah_proses_eselon_5')]); ?>
            <div class="form-body">
