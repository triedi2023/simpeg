<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdatestruktur1 horizontal-form", 'data-url' => isset($id) ? site_url('referensi_struktur/ubah_proses?id='.$id) : site_url('referensi_struktur/tambah_proses')]); ?>
            <div class="form-body">
...
<script type="text/javascript">
    ...
    $("select#field_cr_eselonbkn").select2();
