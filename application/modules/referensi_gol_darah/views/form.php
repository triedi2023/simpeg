<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('referensi_gol_darah/ubah_proses?id='.$id) : site_url('referensi_gol_darah/tambah_proses')]); ?>
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="gol_darah" id="field_cr_nama_jenjang" class="form-control" value="<?php echo isset($id) ? $model->GOL_DARAH : set_value('gol_darah'); ?>" maxlength="2" minlength="1" placeholder="Golongan Darah" />
                        </div>
                    </div>
                    <!--/span-->
                    <div class="col-md-6">
