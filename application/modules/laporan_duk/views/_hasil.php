...
<div class="col-md-12">
    ...
    <div class="portlet light ">
        <div class="portlet-title">
            ...
            <div class="actions">
                <div class="btn-group btn-group-devided" data-toggle="buttons">
                    ...
                    <a class="btn btn-transparent red btn-outline btn-circle btn-sm btnexport" data-url="<?php echo site_url("laporan_duk/export_excel") ?>">
        ...
        <div class="portlet-body">
            <h1 class="text-center">Daftar Urut Kepangkatan</h1>
            <?php echo $nmstruktur; ?>
                ...
                <table class="table table-bordered table-hover table-striped table-advance">
                    <thead>
                        <tr>
                            ...
                            <th class="text-left" style="width: 20%;vertical-align: middle;"> Nama / NIP / Tgl Lahir / Umur </th>
                            <th class="text-left" style="width: 10%;vertical-align: middle;"> Gol / Ruang / TMT </th>
                            <th class="text-center" style="vertical-align: middle;"> Jabatan<br />TMT Jabatan<br /> TMT Eselon </th>
                            <th class="text-center" style="width: 10%;vertical-align: middle;"> MK Total<br />(Tahun Bulan) </th>
                            <th class="text-center" style="width: 10%;vertical-align: middle;"> Diklat PIM<br />Angkatan<br />Tahun </th>
                            <th class="text-center" style="width: 10%;vertical-align: middle;"> Pendidikan </th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                        ...
                        <?php if ($model): ?>
                            ...
                            foreach ($model as $val):
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo $nama."<br />".$val['NIPNEW']."<br />".$val['TGLLAHIR']."<br />".$val['UMUR'] ?> </td>
                                    <td> <?php echo $val['PANGKAT']." (".$val['GOLONGAN_RUANG'].") "."<br />".$val['TMT_GOL'] ?> </td>
                                    <td> <?php echo $val['N_JABATAN']."<br />".$val['TMT_JABATAN']."<br />".$val['TMT_ESELON'] ?> </td>
                                    <td> <?php echo $val['MK_THN_TOTAL']." Tahun ".$val['MK_BLN_TOTAL']." Bulan" ?> </td>
                                    <td> <?php echo $val['NAMA_JENJANG']."<br />".$val['ANGKATAN_DIKLAT']."<br />".$val['THN_DIKLAT'] ?> </td>
