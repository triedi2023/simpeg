                    ...
                    <div class="container-fluid">
                        ...
                        <div class="page-content-inner">
                            <div class="m-heading-1 border-green m-bordered">
                                <h3>Parameter</h3>
                                <div class="form">
                                    <form action="#" class="form-horizontal" id="formpencarian" data-url="<?php echo site_url("laporan_duk/pencarian_proses") ?>">
                                        <div class="form-body">
                                            <?php $this->load->view('system/unitkerja_form-horizontal_filter'); ?>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3">Tingkat Golongan</label>
                                                        <div class="col-md-7">
                                                            <select name="tingkat_golongan" id="tingkat_golongan" class="form-control" style="width: 100%">
