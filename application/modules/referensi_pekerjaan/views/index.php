                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="search_pekerjaan" placeholder="Pekerjaan" class="form-control" />
                                        </div>
                                    </div>
                                    <!--/span-->
                                    <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="portlet box blue-dark">
                                        ...
                                        <div class="portlet-body">
                                            <div class="table-container" data-url="<?php echo site_url('referensi_pekerjaan/ajax_list') ?>">
