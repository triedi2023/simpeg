...
class Laporan_periodik extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model(array('laporan_periodik/laporan_periodik_model', 'list_model'));
        $this->load->helper(array('form', 'app_helper'));
        $this->data['plugin_js'] = ['assets/plugins/select2/js/select2.full.min.js'];
        $this->data['custom_js'] = ['laporan_periodik/js', 'system/unitkerja_form-horizontal_filter_js'];
        $this->data['title_utama'] = 'Periodik';
    }

    public function index() {
        $this->data['content'] = 'laporan_periodik/index';
    ...
    public function pencarian_proses() {
        ...
        $this->data['model'] = $this->laporan_periodik_model->get_data($lokasi_id, $kdu1, $kdu2, $kdu3, $kdu4, $kdu5);
        $this->data['struktur'] = $this->laporan_periodik_model->get_struktur($lokasi_id, $kdu1, $kdu2, $kdu3, $kdu4, $kdu5);

        $this->load->view("laporan_periodik/_hasil", $this->data);
    }
    ...
    public function export_excel() {
        ...
        $model = $this->laporan_periodik_model->get_data($lokasi_id, $kdu1, $kdu2, $kdu3, $kdu4, $kdu5);
        $struktur = $this->laporan_periodik_model->get_struktur($lokasi_id, $kdu1, $kdu2, $kdu3, $kdu4, $kdu5);
        $jumlah = count($model);
        ...
        $objPHPExcel->setActiveSheetIndex(0)
                ...
                ->setCellValue('D' . $judultabel, "Jabatan / a.TMT Jabatan / b.TMT Eselon")
                ...
                ->setCellValue('I' . $judultabel, "Pendidikan");
    ...
    public function export_pdf() {
        ...
        $this->data['model'] = $this->laporan_periodik_model->get_data($lokasi_id, $kdu1, $kdu2, $kdu3, $kdu4, $kdu5);
        $this->data['struktur'] = $this->laporan_periodik_model->get_struktur($lokasi_id, $kdu1, $kdu2, $kdu3, $kdu4, $kdu5);
        $this->data['content'] = 'laporan_periodik/pdf';
