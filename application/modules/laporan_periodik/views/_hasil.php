...
<div class="col-md-12">
    ...
    <div class="portlet light ">
        <div class="portlet-title">
            ...
            <div class="actions">
                <div class="btn-group btn-group-devided" data-toggle="buttons">
                    ...
                    <a class="btn btn-transparent red btn-outline btn-circle btn-sm btnexport" data-url="<?php echo site_url("laporan_periodik/export_excel") ?>">
                        <i class="fa fa-file-excel-o"></i> Excel
                    </a>
                    <!-- a class="btn btn-transparent red btn-outline btn-circle btn-sm btnexport" data-url="<?php echo site_url("laporan_periodik/export_pdf") ?>">
        ...
        <div class="portlet-body">
            <h1 class="text-center">Laporan Periodik</h1>
            <?php echo $nmstruktur; ?>
                ...
                <table class="table table-bordered table-hover table-striped table-advance">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="vertical-align: middle;"> Nama / NIP / Tgl Lahir / Umur </th>
                            <th class="text-center" style="vertical-align: middle;"> Gol / Ruang / TMT </th>
                            <th class="text-center" style="vertical-align: middle;"> Jabatan<br />a. TMT Jabatan<br />b. TMT Eselon </th>
                        ...
                        <?php if ($model): ?>
                            ...
                            foreach ($model as $val):
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo $nama."<br />".$val['NIPNEW']."<br />".$val['TGLLAHIR']."<br />".$val['UMUR']."<br />" ?><img width="100%" src="<?= base_url() ?>_uploads/photo_pegawai/thumbs/<?= trim($val['FOTO']) ?>" /> </td>
                                    <td> <?php echo (($val['TRSTATUSKEPEGAWAIAN_ID'] == '1') ? $val['PANGKAT']." (".$val['GOLONGAN_RUANG'].") " : $val['PANGKAT'])."<br />".$val['TMT_GOL'] ?> </td>
                                    <td>
                                        <?php if ($val['dtl_jabatan']): ?>
                                            <?php $k=1; foreach ($val['dtl_jabatan'] as $isi): ?>
                                                <?php echo $k.". ".$isi['N_JABATAN']."<br />".$isi['TMT_JABATAN2']."<br />".$isi['TMT_ESELON2']."<hr />" ?>
                                            <?php $k++;endforeach ?>
                                        <?php endif ?>
                                    </td>
                                    <td>
                                        <?php if ($val['diklat_pim']): ?>
                                            <?php $k=1; foreach ($val['diklat_pim'] as $isi): ?>
                                                <?php echo $k.". ".$isi['NAMA_JENJANG']."<br />".$isi['THN_DIKLAT']."<hr />" ?>
                                            <?php $k++;endforeach ?>
                                        <?php endif ?>
                                    </td>
                                    <td>
                                        <?php if ($val['diklat_fungsional']): ?>
                                            <?php $k=1; foreach ($val['diklat_fungsional'] as $isi): ?>
                                                <?php echo $k.". ".$isi['JENIS_DIKLAT_FUNGSIONAL']."<br />".$isi['KELOMPOK_FUNGSIONAL']." ".$isi['PENJENJANGAN_FUNGSIONAL']." ".$isi['NAMA_PENJENJANGAN']."<hr />" ?>
                                            <?php $k++;endforeach ?>
                                        <?php endif ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <?php if ($val['pendidikan']): ?>
                                            <?php $k=1; foreach ($val['pendidikan'] as $isi): ?>
                                                <?php echo $k.". ".$isi['TINGKAT_PENDIDIKAN']." ".$isi['NAMA_JURUSAN']."<hr />" ?>
                                            <?php $k++;endforeach ?>
                                        <?php endif ?>
                                    </td>
                                </tr>
