<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('referensi_jenis_libur/ubah_proses?id=' . $id) : site_url('referensi_jenis_libur/tambah_proses')]); ?>
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="jenis_libur" id="field_cr_jenis_libur" class="form-control" value="<?php echo isset($id) ? $model->JENIS_LIBUR : set_value('jenis_libur'); ?>" placeholder="Jenis Libur" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
...
<script>
    $("select#field_cr_nama_libur").select2();
