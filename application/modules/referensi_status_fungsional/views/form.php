<div class="col-md-12">
    <div class="portlet box yellow-gold">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <?php echo form_open("://", ["class" => "formcreateupdate horizontal-form", 'data-url' => isset($id) ? site_url('referensi_status_fungsional/ubah_proses?id=' . $id) : site_url('referensi_status_fungsional/tambah_proses')]); ?>
            <div class="form-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="status_fungsional" id="field_cr_status_fungsional" class="form-control" value="<?php echo isset($id) ? $model->STATUS_FUNGSIONAL : set_value('status_fungsional'); ?>" placeholder="Status Fungsional" />
                        </div>
                    </div>
                    <!--/span-->
                    <div class="col-md-6">
