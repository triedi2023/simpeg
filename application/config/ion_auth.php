...
*/
$config['tables']['users']           = 'SYSTEM_USER';
$config['tables']['groups']          = 'SYSTEM_GROUP';
$config['tables']['users_groups']    = 'SYSTEM_USER_GROUP';
 ...
 */
$config['join']['users']  = 'SYSTEMUSER_ID';
$config['join']['groups'] = 'SYSTEMGROUP_ID';
...
$config['default_group']              = 'pegawai';           // Default group, use name
...
$config['recheck_timer']              = 120;                   /* The number of seconds after which the session is checked again against database to see if the user still exists and is active.
