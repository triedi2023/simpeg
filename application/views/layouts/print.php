...
<html lang="en">
    ...
    <head>
        ...
        <link href="<?php echo base_url() ?>assets/css/fonts?family=Open+Sans:400,300,600,700&subset=all" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo base_url() ?>assets/css/bootstrap.min.css?v=<?php echo uniqid(); ?>" rel="stylesheet" id="style_components" type="text/css" />
