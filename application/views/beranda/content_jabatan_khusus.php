                            ...
                            <?php if ($model): ?>
                                <?php $jmltotal = 0; $i=1; foreach ($model as $val): ?>
                                    <tr>
                                        ...
                                        <td class="text-left"> <?php echo $val['jabatan'];?> </td>
                                        <td class="text-center"> <a href="javascript:;" data-indetify="contentjabatan" class="popuplarge" data-url="<?php echo site_url('daftar_pegawai_lengkap/listpegawai?tipe=3&id='.$val['id']); ?>"><?php echo $val['value'];?> Pegawai</a> </td>
                                        <td class="text-center"> <?php echo round(($val['value'] * 100) / $total, 2);?> % </td>
                                    </tr>
                                <?php $i++;$jmltotal += ($val['value'] * 100) / $total; endforeach; ?>
                                <tr>
