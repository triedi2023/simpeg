                            ...
                            <?php if ($model): ?>
                                <?php $jmltotal = 0; $i=1; foreach ($model as $val): ?>
                                    <tr>
                                        ...
                                        <td class="text-center"> <a href="javascript:;" data-indetify="contentjabatan" class="popuplarge" data-url="<?php echo site_url('daftar_pegawai_lengkap/listpegawai?tipe=4&id='.$val['id']); ?>"><?php echo $val['value'];?> Pegawai</a> </td>
