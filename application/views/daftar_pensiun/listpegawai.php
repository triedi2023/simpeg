<div class="modal-header bg-yellow-soft bg-font-yellow-soft" style="padding: 10px">
    ...
    <h4 class="modal-title bg-font-blue-madison font-lg sbold pull-left">Daftar Pegawai Yang Akan Pensiun</h4>
</div>
<div class="modal-body">
    ...
    <div class="panel-success">
        <div class="table-container" data-url="<?php echo site_url('daftar_pensiun/ajax_listpensiun') ?>">
...
<script>
    var datasearch = function (data) {
        data.bulan = '<?php echo ($bulan) ? $bulan : '' ?>';
        data.nama = $('#nama_nip').val();
    ...
    var $popuplistpegawai = $('table.popuplistpegawai').DataTable({
        ...
        processing: true,
        ajax: {
            url: '<?php echo site_url('daftar_pensiun/ajax_listpensiun') ?>',
            type: 'POST',
            data: datasearch
        }
    });
