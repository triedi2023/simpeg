var Layout = function () {
    var e = "layouts/layout3/img/", t = "layouts/layout3/css/", o = App.getResponsiveBreakpoint("lg"),
            n = function () {
                $(".page-header").on("click", ".search-form", function (e) {
                    ...
                    if (13 == e.which)
                        return $(this).closest(".search-form").submit(), !1
        ...
        $(".page-header .menu-toggler").on("click", function (e) {
            if (App.getViewPort().width < o) {
                var t = $(".page-header .page-header-menu");
                t.is(":visible") ? t.slideUp(300) : t.slideDown(300), $("body").hasClass("page-header-top-fixed") && App.scrollTop()
            }
        ...
        var n = encodeURI(location.hash).toLowerCase(), i = $(".hor-menu");
        "click" === e || "set" === e ? t = $(t) : "match" === e && i.find("li > a").each(function () {
            ...
            if (o && e) {
                ...
                if (i && (i = i.toLowerCase(), i.length > 1 && n.substr(1, i.length - 1) == i.substr(1)))
                    return void(t = $(this))
            }
        }), t && 0 != t.size() && "javascript:;" != t.attr("href") && "javascript:;" != t.attr("ui-sref") && "#" != t.attr("href") && "#" != t.attr("ui-sref") && (i.find("li.active").removeClass("active"), i.find("li > a > .selected").remove(), i.find("li.open").removeClass("open"), t.parents("li").each(function () {
        ...
        $(".page-header-menu");
        e >= o ? $(".page-header-menu").css("display", "block") : e < o && $(".page-header-menu").css("display", "none")
    }, r = function () {
    ...
    return{initHeader: function (e) {
        ...
        }, setMainMenuActiveLink: function (e, t) {
            a(e, t)
        }, setAngularJsMainMenuActiveLink: function (e, t, o) {
            a(e, t, o)
