var App = function () {
    var t, e = !1, o = !1, a = !1, i = !1, n = [], l = "../assets/", s = "img/", r = "plugins/", c = "css/",
            d = {blue: "#89C4F4", red: "#F3565D", green: "#1bbc9b", purple: "#9b59b6", grey: "#95a5a6", yellow: "#F8CB00"},
            p = function () {
                "rtl" === $("body").css("direction") && (e = !0), o = !!navigator.userAgent.match(/MSIE 8.0/), a = !!navigator.userAgent.match(/MSIE 9.0/),
                        i = !!navigator.userAgent.match(/MSIE 10.0/), i && $("html").addClass("ie10"), (i || a || o) && $("html").addClass("ie")
            },
            h = function () {
    ...
    return{init: function () {
            ...
            t = $.extend(!0, {}, t);
            var e = "";
            if (e = t.animate ? '<div class="loading-message ' + (t.boxed ? "loading-message-boxed" : "") + '"><div class="block-spinner-bar"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>' : t.iconOnly ? '<div class="loading-message ' + (t.boxed ? "loading-message-boxed" : "") + '"><img src="' + this.getGlobalImgPath() + 'loading-spinner-grey.gif" align=""></div>' : t.textOnly ? '<div class="loading-message ' + (t.boxed ? "loading-message-boxed" : "") + '"><span>&nbsp;&nbsp;' + (t.message ? t.message : "Mohon Tunggu...") + "</span></div>" : '<div class="loading-message ' + (t.boxed ? "loading-message-boxed" : "") + '"><img src="' + this.getGlobalImgPath() + 'loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (t.message ? t.message : "Mohon Tunggu...") + "</span></div>", t.target) {
                var o = $(t.target);
                o.height() <= $(window).height() && (t.cenrerY = !0), o.block({message: e, baseZ: t.zIndex ? t.zIndex : 1e3, centerY: void 0 !== t.cenrerY && t.cenrerY, css: {top: "10%", border: "0", padding: "0", backgroundColor: "none"}, overlayCSS: {backgroundColor: t.overlayColor ? t.overlayColor : "#555", opacity: t.boxed ? .05 : .1, cursor: "wait"}})
            } else
...
jQuery(document).ready(function () {
    ...
    $('body').on('click','#expandDropDown',function () {
...
function note_sukses(element, pesan) {
    $(element).prev('div.note').remove();
    $('<div class="note note-success"><h4 class="block">Sukses!</h4><p> Data berhasil ' + pesan + '. </p></div>').insertBefore(element);
    setInterval(function () {
        $(element).prev('div.note').remove();
    }, 3000);
}

function note_gagal(element, pesan) {
    $(element).prev('div.note').remove();
    $('<div class="note note-danger"><h4 class="block">Error!</h4><p> Data gagal ' + pesan + '. </p></div>').insertBefore(element);
    setInterval(function () {
        $(element).prev('div.note').remove();
    }, 3000);
}