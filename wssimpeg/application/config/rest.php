...
|
*/
$config['rest_auth'] = 'FALSE'; /// oke tandain dulu ini kuncinya disini
...
|
*/
$config['auth_library_class'] = 'library_auth';
$config['auth_library_function'] = 'user_credential';
...
|
*/
$config['rest_valid_logins'] = ['admin' => '1234']; /// kamu bisa set user paswordnya disini.. ini defaultnya
